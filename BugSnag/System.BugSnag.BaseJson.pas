...
constructor TBaseJson.Create;
begin
  inherited;
  FOptions := [joDateIsUTC, joDateFormatISO8601];
end;

function TBaseJson.GetAsJson: string;
begin
...
class procedure TBaseJson.PrettyPrintJSON(aJSONValue: TJsonValue; aOutputStrings: TStrings; Indent: Integer);
var
  i: Integer;
  Ident: Integer;
begin
...
class procedure TBaseJson.PrettyPrintArray(aJSONValue: TJSONArray; aOutputStrings: TStrings; Last: Boolean;
  Indent: Integer);
var
  i: Integer;
begin
...
class function TBaseJson.PrettyPrintJSON(aJson: string): string;
var
...
class procedure TBaseJson.PrettyPrintPair(aJSONValue: TJSONPair; aOutputStrings: TStrings; Last: Boolean;
  Indent: Integer);
const
  TEMPLATE = '%s:%s';
var
...
procedure TBaseJson.SetAsJson(aValue: string);
var
